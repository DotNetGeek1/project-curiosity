# About Page Launch Copy

| Field            | Value          |
| ---------------- | -------------- |
| **Document ID**  | CNT-LAUNCH-002 |
| **Status**       | Draft          |
| **Version**      | 1.0            |
...
Define the first approved copy set for the About page described by `UX-004-ABOUT-PAGE.md`.
...
I am a software engineer and technical leader who enjoys ambiguous problems, unfamiliar technologies and building the first working version. I have led engineering teams while remaining hands-on across product engineering, architecture, cloud infrastructure, developer tooling and applied AI.

### 20-word version

Software engineer and technical leader. I explore difficult questions, build prototypes and turn promising ideas into useful systems.

### Footer version

I build software by following interesting questions far enough to learn something useful.

---

## Factual Review Required

Before publication, confirm:

- the current wording of `more than twenty-five years`;
- the maximum team size and management wording;
- availability and URL of the public CV;
- whether any project or employer-specific examples require additional confidentiality review.

## Acceptance Criteria

- [ ] The page uses first-person language throughout.
- [ ] Leadership and hands-on engineering are both visible.
- [ ] The page explains why the site exists without sounding defensive.
- [ ] Technology breadth is framed as problem-led learning rather than a skills inventory.
- [ ] The copy contains no claims that I would be uncomfortable defending in an interview.
