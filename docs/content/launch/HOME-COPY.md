...
Define the first approved copy set for the homepage described by `UX-001-HOMEPAGE.md`.

This copy is intended to be implemented as structured content. It may be edited for rhythm and fit during visual implementation, but its meaning and first-person voice must remain intact.
...
## Selected Experiments Introduction
...
This list should remain editable and should not be treated as a permanent skills inventory.
...
I am a software engineer and technical leader who enjoys difficult problems, unfamiliar territory and building things that make other people more effective.

---

## Implementation Notes

1. The hero should not add a job-title slogan above the main heading.
2. Do not introduce claims such as `25+ years` into the hero unless the About page and CV are already linked and the number has been reviewed.
3. Experiment state labels must come from structured content rather than this copy file once implementation begins.
4. `Escaped containment` is permitted only for Morris.
5. The GitHub call to action should link to the public profile, not imply that every experiment repository is public.

## Acceptance Criteria

- [ ] The homepage leads with the notebook concept and questions.
- [ ] All personal writing is in the first person.
- [ ] Technology does not dominate the hero or card headings.
- [ ] No unsupported outcome or commercial-success claims are introduced.
- [ ] A reader can understand the purpose of the site without scrolling.
