  ...
  return (
    <Container>
      <div className="lg:grid lg:grid-cols-[2.5rem_minmax(0,1fr)] lg:gap-10">
        <NotebookSpine label="Engineering notebook" />
        ...
        <div>
          <section className="grid items-center gap-10 py-20 sm:py-28 lg:grid-cols-[minmax(0,1fr)_minmax(0,30rem)] lg:gap-14">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-lg text-ink-muted">
                ...
                idea that I cannot leave alone until I have built enough of it to find out whether
                it works.
              </p>
              <p className="mt-4 text-lg text-ink-muted">
          ...
          <section
            ...
            className="border-t border-rule pt-16 pb-8"
          >
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-ink-muted">
                They are connected less by technology than by the way they started: I noticed
                something, wondered whether it could work differently and built enough to find out.
              </p>
            </div>
            <div className="mt-10">
          ...
          <section aria-labelledby="working-style-heading" className="border-t border-rule py-16">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-ink-muted">
                I like taking a loose problem, turning it into something testable and building the
                first working version. That might mean a technical spike, a reference
                implementation, a reusable platform component or a small tool that removes friction
                for everyone else.
              </p>
              <p className="mt-4 text-ink-muted">
            ...
            <ul className="mt-8 max-w-2xl space-y-3">
              {currentObsessions.map((item) => (
                <li key={item} className="flex items-baseline gap-4 text-ink-muted">
                  <span
                    aria-hidden="true"
                    className="size-1.5 shrink-0 rounded-full bg-accent-rust"
                  />
                  {item}
                </li>
              ))}
