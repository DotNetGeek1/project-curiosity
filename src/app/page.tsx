    ...
    <Container>
      <section className="max-w-2xl py-20 sm:py-28">
        ...
        <p className="mt-4 text-lg text-ink-muted">
          ...
          technology I want to understand properly. Occasionally it is a slightly unreasonable idea
          that I cannot leave alone until I have built enough of it to find out whether it works.
        </p>
        <p className="mt-4 text-lg text-ink-muted">
          This is where I document those experiments: what prompted them, what I tried, what failed,
          what changed my mind and what I learned along the way.
        </p>
